...
create table if not exists applyVoucher(
	...
	productId integer,
	primary key(id),
	foreign key(voucherId) references discountVouchers(id),
	foreign key(productId) references products(id),
...
((select id from products where name = 'Thắt lưng nam cao cấp'), '/img/products/1-2.png'),
((select id from products where name = 'Thắt lưng nam cao cấp'), '/img/products/1-3.png'),
((select id from products where name = 'Thắt lưng nam cao cấp'), '/img/products/1-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Thắt lưng nam cao cấp'), 210000, '/img/products/1-v1.png', 'Vàng', 'Chỉ thắt lưng', null, rand()*5000, rand()*1000),
((select id from products where name = 'Thắt lưng nam cao cấp'), 250000, '/img/products/1-v1.png', 'Vàng', 'Thắt lưng + hộp', null, rand()*5000, rand()*1000),
((select id from products where name = 'Thắt lưng nam cao cấp'), 210000, '/img/products/1-v2.png', 'Đen', 'Chỉ thắt lưng', null, rand()*5000, rand()*1000),
((select id from products where name = 'Thắt lưng nam cao cấp'), 250000, '/img/products/1-v2.png', 'Đen', 'Thắt lưng + hộp', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Tất Trơn nam nữ'), '/img/products/2-2.png'),
((select id from products where name = 'Tất Trơn nam nữ'), '/img/products/2-3.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Tất Trơn nam nữ'), 23000, '/img/products/2-v1.png', 'Đen', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Tất Trơn nam nữ'), 23000, '/img/products/2-v2.png', 'Trắng', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Áo Thun AM Nam Nữ'), '/img/products/3-2.png'),
((select id from products where name = 'Áo Thun AM Nam Nữ'), '/img/products/3-3.png'),
((select id from products where name = 'Áo Thun AM Nam Nữ'), '/img/products/3-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Áo Thun AM Nam Nữ'), 42000, '/img/products/3-v1.png', 'Đen', '30-45kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo Thun AM Nam Nữ'), 42000, '/img/products/3-v2.png', 'Trắng', '30-45kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo Thun AM Nam Nữ'), 42000, '/img/products/3-v3.png', 'Be', '30-45kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo Thun AM Nam Nữ'), 50000, '/img/products/3-v1.png', 'Đen', '45-70kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo Thun AM Nam Nữ'), 50000, '/img/products/3-v2.png', 'Trắng', '45-70kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo Thun AM Nam Nữ'), 50000, '/img/products/3-v3.png', 'Be', '45-70kg', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), '/img/products/4-2.png'),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), '/img/products/4-3.png'),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), '/img/products/4-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 69000, '/img/products/4-v1.png', 'Đen', 's', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 70000, '/img/products/4-v2.png', 'Trắng', 's', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 71000, '/img/products/4-v3.png', 'Đỏ đô', 's', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 72000, '/img/products/4-v1.png', 'Đen', 'm', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 73000, '/img/products/4-v2.png', 'Trắng', 'm', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 74000, '/img/products/4-v3.png', 'Đỏ đô', 'm', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 75000, '/img/products/4-v1.png', 'Đen', 'l', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 76000, '/img/products/4-v2.png', 'Trắng', 'l', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 77000, '/img/products/4-v3.png', 'Đỏ đô', 'l', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 78000, '/img/products/4-v1.png', 'Đen', 'xl', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 79000, '/img/products/4-v2.png', 'Trắng', 'xl', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 80000, '/img/products/4-v3.png', 'Đỏ đô', 'xl', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 81000, '/img/products/4-v1.png', 'Đen', 'xxl', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 82000, '/img/products/4-v2.png', 'Trắng', 'xxl', null, rand()*5000, rand()*1000),
((select id from products where name = 'Áo thun ôm body cotton lông mịn'), 83000, '/img/products/4-v3.png', 'Đỏ đô', 'xxl', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), '/img/products/5-2.png'),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), '/img/products/5-3.png'),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), '/img/products/5-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 24000, '/img/products/5-v.png', 'USB-C', '1m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 25000, '/img/products/5-v.png', 'Micro USB', '1m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 26000, '/img/products/5-v.png', 'Apple Lightning', '1m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 27000, '/img/products/5-v.png', 'USB-C', '2m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 28000, '/img/products/5-v.png', 'Micro USB', '2m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 29000, '/img/products/5-v.png', 'Apple Lightning', '2m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 30000, '/img/products/5-v.png', 'USB-C', '3m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 31000, '/img/products/5-v.png', 'Micro USB', '3m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Cáp sạc nhanh Essager 3A'), 32000, '/img/products/5-v.png', 'Apple Lightning', '3m', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Dây Cáp Baseus PD 20W'), '/img/products/6-2.png'),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), '/img/products/6-3.png'),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), '/img/products/6-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Dây Cáp Baseus PD 20W'), 100000, '/img/products/6-v1.png', 'Trắng', '1m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), 100000, '/img/products/6-v2.png', 'Xanh lam', '1m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), 100000, '/img/products/6-v3.png', 'Tím', '1m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), 100000, '/img/products/6-v1.png', 'Trắng', '2m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), 100000, '/img/products/6-v2.png', 'Xanh lam', '2m', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Cáp Baseus PD 20W'), 100000, '/img/products/6-v3.png', 'Tím', '2m', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Ghế Gội Đầu Cho Bé Cỡ Đại'), '/img/products/7-2.png'),
((select id from products where name = 'Ghế Gội Đầu Cho Bé Cỡ Đại'), '/img/products/7-3.png'),
((select id from products where name = 'Ghế Gội Đầu Cho Bé Cỡ Đại'), '/img/products/7-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Ghế Gội Đầu Cho Bé Cỡ Đại'), 69000, '/img/products/7-v1.png', 'Hồng nhỏ', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Ghế Gội Đầu Cho Bé Cỡ Đại'), 70000, '/img/products/7-v2.png', 'Hồng lớn', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Ghế Gội Đầu Cho Bé Cỡ Đại'), 71000, '/img/products/7-v3.png', 'Xanh nhỏ', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Tinh Dầu Thơm Thiên Nhiên'), '/img/products/8-2.png'),
((select id from products where name = 'Tinh Dầu Thơm Thiên Nhiên'), '/img/products/8-3.png'),
((select id from products where name = 'Tinh Dầu Thơm Thiên Nhiên'), '/img/products/8-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Tinh Dầu Thơm Thiên Nhiên'), 55000, '/img/products/8-v1.png', 'Chanh', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Tinh Dầu Thơm Thiên Nhiên'), 56000, '/img/products/8-v2.png', 'Trà', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Tinh Dầu Thơm Thiên Nhiên'), 57000, '/img/products/8-v3.png', 'Cà phê', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Switch Leobog GrayWood V4'), '/img/products/9-2.png'),
((select id from products where name = 'Switch Leobog GrayWood V4'), '/img/products/9-3.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Switch Leobog GrayWood V4'), 3000, '/img/products/9-v1.png', 'Leopog', 'prelube', null, rand()*5000, rand()*1000),
((select id from products where name = 'Switch Leobog GrayWood V4'), 4000, '/img/products/9-v2.png', 'Leopog', 'lube', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Bộ Dụng Cụ Bấm Móng Tay 16 món'), '/img/products/10-2.png'),
((select id from products where name = 'Bộ Dụng Cụ Bấm Móng Tay 16 món'), '/img/products/10-3.png'),
((select id from products where name = 'Bộ Dụng Cụ Bấm Móng Tay 16 món'), '/img/products/10-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
...
insert into productImages(productId, image) values
((select id from products where name = 'Thẻ nhớ Micro SD'), '/img/products/11-2.png'),
((select id from products where name = 'Thẻ nhớ Micro SD'), '/img/products/11-3.png'),
((select id from products where name = 'Thẻ nhớ Micro SD'), '/img/products/11-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Thẻ nhớ Micro SD'), 150000, '/img/products/11-v1.png', '32GB', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Thẻ nhớ Micro SD'), 300000, '/img/products/11-v2.png', '64GB', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Thẻ nhớ Micro SD'), 450000, '/img/products/11-v3.png', '128GB', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Thẻ nhớ Micro SD'), 600000, '/img/products/11-v4.png', '256GB', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Cây ngoáy tai đầu bông êm ái'), '/img/products/12-2.png'),
((select id from products where name = 'Cây ngoáy tai đầu bông êm ái'), '/img/products/12-3.png'),
((select id from products where name = 'Cây ngoáy tai đầu bông êm ái'), '/img/products/12-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
...
insert into productImages(productId, image) values
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), '/img/products/13-2.png'),
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), '/img/products/13-3.png'),
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), '/img/products/13-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), 39000, '/img/products/13-v1.png', 'Đen', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), 40000, '/img/products/13-v2.png', 'Xanh', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), 41000, '/img/products/13-v3.png', 'Đỏ', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Đồng hồ điện tử nam nữ Sport S042Z'), 42000, '/img/products/13-v4.png', 'Vàng', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), '/img/products/14-2.png'),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), '/img/products/14-3.png'),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), '/img/products/14-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 125000, '/img/products/14-v1.png', 'Trắng kem', '19-20', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 126000, '/img/products/14-v2.png', 'Đen', '20-21', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 127000, '/img/products/14-v3.png', 'Nâu nhạt', '21-22', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 125000, '/img/products/14-v1.png', 'Trắng kem', '22-23', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 126000, '/img/products/14-v2.png', 'Đen', '23-24', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 127000, '/img/products/14-v3.png', 'Nâu nhạt', '24-25', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 125000, '/img/products/14-v1.png', 'Trắng kem', '25-26', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 126000, '/img/products/14-v2.png', 'Đen', '26-27', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Sục Nam Nữ NESTY'), 127000, '/img/products/14-v3.png', 'Nâu nhạt', '27-28', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), '/img/products/15-2.png'),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), '/img/products/15-3.png'),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), '/img/products/15-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 53000, '/img/products/15-v1.png', 'Trắng', '36', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 53000, '/img/products/15-v2.png', 'Đen', '36', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 53000, '/img/products/15-v3.png', 'Đen caro', '36', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 53000, '/img/products/15-v4.png', 'Trắng caro', '36', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 77000, '/img/products/15-v1.png', 'Trắng', '37', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 77000, '/img/products/15-v2.png', 'Đen', '37', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 77000, '/img/products/15-v3.png', 'Đen caro', '37', null, rand()*5000, rand()*1000),
((select id from products where name = 'Dép Nam, Nữ Quai Ngang Đúc Liền Khối Siêu Nhẹ DUWA'), 77000, '/img/products/15-v4.png', 'Trắng caro', '37', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Túi cói Merci đi du lịch'), '/img/products/16-2.png'),
((select id from products where name = 'Túi cói Merci đi du lịch'), '/img/products/16-3.png'),
((select id from products where name = 'Túi cói Merci đi du lịch'), '/img/products/16-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
...
insert into productImages(productId, image) values
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), '/img/products/17-2.png'),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), '/img/products/17-3.png'),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), '/img/products/17-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), 65000, '/img/products/17-v1.png', 'Xanh than', '5000 MAH', null, rand()*5000, rand()*1000),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), 65000, '/img/products/17-v2.png', 'Hồng', '5000 MAH', null, rand()*5000, rand()*1000),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), 65000, '/img/products/17-v3.png', 'Trắng', '5000 MAH', null, rand()*5000, rand()*1000),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), 65000, '/img/products/17-v1.png', 'Xanh than', '10000 MAH', null, rand()*5000, rand()*1000),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), 65000, '/img/products/17-v2.png', 'Hồng', '10000 MAH', null, rand()*5000, rand()*1000),
((select id from products where name = 'Quạt kẹp bàn tích điện 5 mức độ'), 65000, '/img/products/17-v3.png', 'Trắng', '10000 MAH', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Ô Dù Mini gấp gọn'), '/img/products/18-2.png'),
((select id from products where name = 'Ô Dù Mini gấp gọn'), '/img/products/18-3.png'),
((select id from products where name = 'Ô Dù Mini gấp gọn'), '/img/products/18-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Ô Dù Mini gấp gọn'), 75000, '/img/products/18-v1.png', 'Hồng', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Ô Dù Mini gấp gọn'), 76000, '/img/products/18-v2.png', 'Trắng', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Ô Dù Mini gấp gọn'), 77000, '/img/products/18-v3.png', 'Đen', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Dây Nhảy Thể Dục Lõi Thép Tập Thể Lực Boxing'), '/img/products/19-2.png'),
((select id from products where name = 'Dây Nhảy Thể Dục Lõi Thép Tập Thể Lực Boxing'), '/img/products/19-3.png'),
((select id from products where name = 'Dây Nhảy Thể Dục Lõi Thép Tập Thể Lực Boxing'), '/img/products/19-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Dây Nhảy Thể Dục Lõi Thép Tập Thể Lực Boxing'), 29000, '/img/products/19-v1.png', 'Đỏ', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Nhảy Thể Dục Lõi Thép Tập Thể Lực Boxing'), 29000, '/img/products/19-v2.png', 'Đen', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Dây Nhảy Thể Dục Lõi Thép Tập Thể Lực Boxing'), 29000, '/img/products/19-v3.png', 'Hồng', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Hạt Điều Rang Muối Nguyên Lụa Bình Phước'), '/img/products/20-2.png'),
((select id from products where name = 'Hạt Điều Rang Muối Nguyên Lụa Bình Phước'), '/img/products/20-3.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Hạt Điều Rang Muối Nguyên Lụa Bình Phước'), 100000, '/img/products/20-v1.png', '250g', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Hạt Điều Rang Muối Nguyên Lụa Bình Phước'), 120000, '/img/products/20-v2.png', '420g', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Hạt Điều Rang Muối Nguyên Lụa Bình Phước'), 140000, '/img/products/20-v3.png', '440g', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Hạt Điều Rang Muối Nguyên Lụa Bình Phước'), 160000, '/img/products/20-v4.png', '225g', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Bơm xe máy xe đạp nhỏ gọn Kiotool'), '/img/products/21-2.png'),
((select id from products where name = 'Bơm xe máy xe đạp nhỏ gọn Kiotool'), '/img/products/21-3.png'),
((select id from products where name = 'Bơm xe máy xe đạp nhỏ gọn Kiotool'), '/img/products/21-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
...
insert into productImages(productId, image) values
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), '/img/products/22-2.png'),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), '/img/products/22-3.png'),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), '/img/products/22-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), 30000, '/img/products/22-v1.png', 'Trong', '1.2kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), 30000, '/img/products/22-v2.png', 'Đục', '1.2kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), 45000, '/img/products/22-v1.png', 'Trong', '1.8kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), 45000, '/img/products/22-v2.png', 'Đục', '1.8kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), 60000, '/img/products/22-v1.png', 'Trong', '2kg', null, rand()*5000, rand()*1000),
((select id from products where name = 'Băng Keo, Băng Dính Trong/Đục 4.8cm - 200Yard'), 60000, '/img/products/22-v2.png', 'Đục', '2kg', null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Túi Đeo Bụng Đựng Điện Thoại'), '/img/products/23-2.png'),
((select id from products where name = 'Túi Đeo Bụng Đựng Điện Thoại'), '/img/products/23-3.png'),
((select id from products where name = 'Túi Đeo Bụng Đựng Điện Thoại'), '/img/products/23-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Túi Đeo Bụng Đựng Điện Thoại'), 29000, '/img/products/23-v1.png', 'Hồng', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Túi Đeo Bụng Đựng Điện Thoại'), 29000, '/img/products/23-v2.png', 'Xanh lá', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Túi Đeo Bụng Đựng Điện Thoại'), 29000, '/img/products/23-v3.png', 'Đỏ', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Balo chống gù PTLUXURY'), '/img/products/24-2.png'),
((select id from products where name = 'Balo chống gù PTLUXURY'), '/img/products/24-3.png'),
((select id from products where name = 'Balo chống gù PTLUXURY'), '/img/products/24-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Balo chống gù PTLUXURY'), 205000, '/img/products/24-v1.png', 'Xanh đỏ', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Balo chống gù PTLUXURY'), 205000, '/img/products/24-v2.png', 'Xanh trắng', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Bộ 20 Thẻ Kích Thích Thị Giác Cho Trẻ'), '/img/products/25-2.png'),
((select id from products where name = 'Bộ 20 Thẻ Kích Thích Thị Giác Cho Trẻ'), '/img/products/25-3.png'),
((select id from products where name = 'Bộ 20 Thẻ Kích Thích Thị Giác Cho Trẻ'), '/img/products/25-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
...
insert into productImages(productId, image) values
((select id from products where name = 'Giấy vệ sinh treo tường TopGia'), '/img/products/26-2.png'),
((select id from products where name = 'Giấy vệ sinh treo tường TopGia'), '/img/products/26-3.png'),
((select id from products where name = 'Giấy vệ sinh treo tường TopGia'), '/img/products/26-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Giấy vệ sinh treo tường TopGia'), 129000, '/img/products/26-v1.png', '4 bịch', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Giấy vệ sinh treo tường TopGia'), 149000, '/img/products/26-v2.png', '6 bịch', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Giấy vệ sinh treo tường TopGia'), 169000, '/img/products/26-v3.png', '9 bịch', null, null, rand()*5000, rand()*1000);
...
insert into productImages(productId, image) values
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), '/img/products/27-2.png'),
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), '/img/products/27-3.png'),
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), '/img/products/27-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), 54000, '/img/products/27-v1.png', 'Nâu', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), 54000, '/img/products/27-v2.png', 'Xám', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), 54000, '/img/products/27-v3.png', 'Xanh non', null, null, rand()*5000, rand()*1000),
((select id from products where name = 'Khay vệ sinh cho mèo LunaPet KM04'), 54000, '/img/products/27-v4.png', 'Xanh dương', null, null, rand()*5000, rand()*1000);
...
((select id from products where name = 'Bảo Hành Rơi Vỡ 12 Tháng cho iPhone, iPad, Apple Watch'), 2);
insert into productImages(productId, image) values
((select id from products where name = 'Bảo Hành Rơi Vỡ 12 Tháng cho iPhone, iPad, Apple Watch'), '/img/products/28-2.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
...
insert into productImages(productId, image) values
((select id from products where name = 'Băng Keo Nano Dán 2 Mặt Trong Suốt'), '/img/products/29-2.png'),
((select id from products where name = 'Băng Keo Nano Dán 2 Mặt Trong Suốt'), '/img/products/29-3.png'),
((select id from products where name = 'Băng Keo Nano Dán 2 Mặt Trong Suốt'), '/img/products/29-4.png');
insert into productVariations(productId, price, image, value1, value2, value3, sold, inStock) values
